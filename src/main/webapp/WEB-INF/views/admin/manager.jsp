		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img
					src="<%=context %>/views/admin/media/image/logo.png" alt="logo" />
				...
				<a href="javascript:;" class="btn-navbar collapsed"
					...
					src="<%=context %>/views/admin/media/image/menu-toggler.png" alt="" />
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar"><a href="#"
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img
										src="<%=context %>/views/admin/media/image/avatar2.jpg" alt="" /></span> <span class="subject">
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img
										src="<%=context %>/views/admin/media/image/avatar3.jpg" alt="" /></span> <span
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img
										src="<%=context %>/views/admin/media/image/avatar1.jpg" alt="" /></span> <span
					...
					<li class="dropdown user"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <img alt=""
							src="<%=context %>/views/admin/media/image/avatar1_small.jpg" /> <span class="username">Bob
