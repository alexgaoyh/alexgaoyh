	...
	<div class="navbar-inner">
		...
		<div class="container-fluid">
			...
			<a class="brand" href="index.html"> <img
				src="${pageContext.request.contextPath}/views/admin/media/image/logo.png" alt="logo" />
			...
			<a href="javascript:;" class="btn-navbar collapsed"
				...
				src="${pageContext.request.contextPath}/views/admin/media/image/menu-toggler.png" alt="" />
				...
				<li class="dropdown" id="header_inbox_bar"><a href="#"
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="${pageContext.request.contextPath}/views/admin/media/image/avatar2.jpg" alt="" /></span>
								<span class="subject"> <span class="from">Lisa
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="${pageContext.request.contextPath}/views/admin/media/image/avatar3.jpg" alt="" /></span>
								<span class="subject"> <span class="from">Richard
