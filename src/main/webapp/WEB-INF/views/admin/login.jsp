...
<title>alexgaoyh | Login Page</title>
...
<link href="<%=context %>/views/admin/media/css/login.css" rel="stylesheet" type="text/css" />
...
<body class="login">
	...
	<div class="logo">
		...
		<img src="<%=context %>/views/admin/media/image/logo-big.png" alt="" />
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="${pageContext.request.contextPath}/admin/doLogin" method="post">
	...
	<script src="<%=context %>/views/admin/media/js/jquery.validate.min.js" type="text/javascript"></script>
	...
	<script src="<%=context %>/views/admin/media/js/login.js" type="text/javascript"></script>
